...
## Security
Most security issues will be handled using built-in firebase scripts. Passwords will not be stored in the database unless hashed, and due to the no-SQL nature of the firebase database, our website will not be at risk for SQL code injections. 
